...
from .views import RegisterView, LoginView, UserListView, AllMessagesListView, MessageListView, SendMessageView, ReceiveMessageView, protected_view, check_admin
